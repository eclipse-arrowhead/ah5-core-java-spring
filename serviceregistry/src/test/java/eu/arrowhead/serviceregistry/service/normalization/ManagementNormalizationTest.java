...
public class ManagementNormalizationTest {
	...
	//-------------------------------------------------------------------------------------------------
	@Test
	public void normalizeCreateServiceInstancesTest2_NullCases() {
		// dto is null
		assertThrows(java.lang.IllegalArgumentException.class, () -> {normalizator.normalizeCreateServiceInstances(null);});
		
		// instance list is null
		assertThrows(java.lang.IllegalArgumentException.class, () -> {normalizator.normalizeCreateServiceInstances(new ServiceInstanceCreateListRequestDTO(null));});
	...
	//-------------------------------------------------------------------------------------------------
	@Test
	public void normalizeUpdateServiceInstancesTest2_NullCases() {
		// dto is null
		assertThrows(java.lang.IllegalArgumentException.class, () -> {normalizator.normalizeUpdateServiceInstances(null);});
		
		// instance list is null
		assertThrows(java.lang.IllegalArgumentException.class, () -> {normalizator.normalizeUpdateServiceInstances(new ServiceInstanceUpdateListRequestDTO(null));});
	...
	public void normalizeRemoveServiceInstancesTest() {
		// instance list is null
		assertThrows(java.lang.IllegalArgumentException.class, () -> {normalizator.normalizeRemoveServiceInstances(null);});
	...
	//-------------------------------------------------------------------------------------------------
	@Test
	public void normalizeQueryServiceInstancesTest2_NullCases() {
		// dto is null
		assertThrows(java.lang.IllegalArgumentException.class, () -> {normalizator.normalizeQueryServiceInstances(null);});

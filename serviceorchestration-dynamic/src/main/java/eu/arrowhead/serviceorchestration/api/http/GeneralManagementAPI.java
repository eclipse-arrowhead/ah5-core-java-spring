...
@RestController
@RequestMapping(DynamicServiceOrchestrationConstants.HTTP_API_GENERAL_MANAGEMENT_PATH)
...
public class GeneralManagementAPI {
	...
	public @ResponseBody LogEntryListResponseDTO getLogEntries(@RequestBody(required = false) final LogRequestDTO dto) {
		...
		final String origin = HttpMethod.POST.name() + " " + DynamicServiceOrchestrationConstants.HTTP_API_GENERAL_MANAGEMENT_PATH + Constants.HTTP_API_OP_LOGS_PATH;
	...
	@GetMapping(path = DynamicServiceOrchestrationConstants.HTTP_API_OP_GET_CONFIG_PATH, produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseBody public KeyValuesDTO getConfig(final @RequestParam(required = false) List<String> keys) {
		...
		final String origin = HttpMethod.GET.name() + " " + DynamicServiceOrchestrationConstants.HTTP_API_GENERAL_MANAGEMENT_PATH + DynamicServiceOrchestrationConstants.HTTP_API_OP_GET_CONFIG_PATH;
